...
conn.execute('''INSERT INTO FoodMenu(dish_name,protein,vitamin,fat,calories,iron,calcium,carb) VALUES('spinach',2.9,3,0.4,23,2.7,99,3.6);''' )
conn.execute('''INSERT INTO FoodMenu(dish_name,protein,vitamin,fat,calories,iron,calcium,carb) VALUES('fenugreek',23,2,6,323,33.5,176,58);''' )
...
conn.execute('''INSERT INTO FoodMenu(dish_name,protein,vitamin,fat,calories,iron,calcium,carb) VALUES('urad',25.21,2,1.64,341,7.57,138,58.99);''' )
...
conn.execute('''INSERT INTO FoodMenu(dish_name,protein,vitamin,fat,calories,iron,calcium,carb) VALUES('dal',22,2,1.5,343,5.2,130,63);''' )
...
conn.execute('''INSERT INTO FoodMenu(dish_name,protein,vitamin,fat,calories,iron,calcium,carb) VALUES('cashew',5.17,1,12.43,157,1.89,10,8.56);''' )
conn.execute('''INSERT INTO FoodMenu(dish_name,protein,vitamin,fat,calories,iron,calcium,carb) VALUES('almond',11,1,2,163,1,76.3,6.1);''' )
conn.execute('''INSERT INTO FoodMenu(dish_name,protein,vitamin,fat,calories,iron,calcium,carb) VALUES('sugar',0,0,0,387,0,0,100);''' )
conn.execute('''INSERT INTO FoodMenu(dish_name,protein,vitamin,fat,calories,iron,calcium,carb) VALUES('honey',0.3,0,0,304,2,0,82);''' )
